...
obj = JarvisAI.JarvisAssistant(sync=True, token='d1cec4b1e6bb0beed13f02e9b6c88f')
            ...
            while True:
                ...
                if re.search('launch', res):
                    dict_app = {
                        ...
                        'sublim text': 'C:\\Program Files\\Sublime Text 3\\sublime_text.exe'
                    }
                ...
                if re.search('what can you do|what can you do', res):
                    li_commands = {
